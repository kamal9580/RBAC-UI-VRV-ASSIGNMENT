...
function RoleTable() {
  ...
  return (
    <div className="container mx-auto w-1/2 h-1.5 p-6">
      <div className="bg-red-500 shadow-lg rounded-lg p-6">
        {/* Header Section */}
        <div className="items-center mb-6">
          ...
          <button
            className="bg-red-600 text-white font-semibold px-5 py-2 rounded-full shadow-lg hover:bg-red-300 transition duration-300"
...
function RoleForm({ onClose, onSave, role, error }) {
  ...
  return (
    <div className="absolute top-0 left-0 w-full h-full bg-gray-800 bg-opacity-50 flex justify-center items-center">
      <div className="bg-red-500 rounded-lg shadow-lg p-6 w-96">
